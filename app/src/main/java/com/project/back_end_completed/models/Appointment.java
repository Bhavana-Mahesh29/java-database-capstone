package com.project.back_end_completed.models;
...
@NotNull(message="doctor detail cannot be null")
@ManyToOne
...
@NotNull(message="Patient detail cannot be null")
@ManyToOne
...
@NotNull(message="staus field cannot be null")
private int status;
